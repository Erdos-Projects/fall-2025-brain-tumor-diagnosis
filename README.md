...
This project contains multiple models that our members worked on (either individually or collaboratively):
- 3D Tumor vs No Tumor
- 2D Tumor vs No Tumor
- 2D Glioblastomas vs Others
- 2D IDH mutation classifier
